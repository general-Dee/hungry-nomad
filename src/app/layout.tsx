  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" type="image/png" sizes="192x192" href="/icons/favicon.ico" />
      ...
      <body className={`${figtree.className} ${caprasimo.variable}`}>
        <Providers>
          <CartProvider>
            <FavoritesProvider>
              <CartDrawerProvider>
                    ...
                    <footer className="bg-neutral-900 text-white py-12 mt-20">
                      <div className="container mx-auto px-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                          {/* Brand */}
                          <div>
                            <h3 className="text-2xl font-bold font-display text-accent-400">Hungry Nomad</h3>
                          ...
                          <div>
                            ...
                            <ul className="space-y-2">
                              <li><Link href="/menu" className="text-neutral-400 hover:text-accent-400 transition">Our Menu</Link></li>
                              <li><Link href="/cart" className="text-neutral-400 hover:text-accent-400 transition">Cart</Link></li>
                              <li><Link href="/track" className="text-neutral-400 hover:text-accent-400 transition">Track Order</Link></li>
                              <li><Link href="/" className="text-neutral-400 hover:text-accent-400 transition">Home</Link></li>
                            </ul>
                          </div>
                        </div>
