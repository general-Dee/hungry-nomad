...
export default function SuccessError({
  ...
  return (
    <div className="container mx-auto px-4 py-16 text-center">
      ...
      <h1 className="text-2xl font-display mb-4">Something went wrong loading your order confirmation</h1>
      <p className="text-gray-600 mb-8">
        If you were charged, your order is still on its way — please contact support with your order ID if anything looks wrong.
      </p>
